...
sink_0::xpos=0 sink_0::ypos=0 sink_0::width=540 sink_0::height=720 \
sink_1::xpos=540 sink_1::ypos=0 sink_1::width=540 sink_1::height=720 ! queue2 ! tee name=t0  \
...
nvarguscamerasrc sensor-id=1 name=source1 sensor-mode=0 ! "video/x-raw(memory:NVMM), width=(int)1080, height=(int)720, format=(string)NV12, framerate=(fraction)30/1"  ! comp. \
nvarguscamerasrc sensor-id=0 name=source2 sensor-mode=0 ! "video/x-raw(memory:NVMM), width=(int)1080, height=(int)720, format=(string)NV12, framerate=(fraction)30/1"  ! comp. \
